...
class Goal(DatesModelMixin):
    ...
    category = models.ForeignKey(
        to=GoalCategory, verbose_name="Категория", on_delete=models.CASCADE, related_name='goals'
    )
    ...
    user = models.ForeignKey(User, on_delete=models.PROTECT, verbose_name="Автор", related_name='goal')
