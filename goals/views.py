...
from goals.permissions import BoardPermission, GoalCategoryPermissions, GoalPermissions, CommentsPermissions
...
class GoalListView(ListAPIView):
    ...
    def get_queryset(self):
        return GoalCategory.objects.select_related('user', 'category__board').filter(
